...
_SECRET_FIELD_PATTERN = re.compile(
    ...
    r"api_secret|public_key_certificate|test_accounts|testAccount|SIG|sign|client_id|api_sign|"
    r"access_key|secret_key|serialnumber|fileMd5|upload_sign|upload_url|file_url|apk_url)\b"
    r"\s*[=:]\s*)[^\s,;]+"
)
